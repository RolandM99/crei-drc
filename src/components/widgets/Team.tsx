            ...
            {teams.map(({ name, occupation, image, items }, index) => (
              <div key={`item-team-${index}`} className="p-2">
                ...
                <div className="relative mt-3 text-center">
                  ...
                  <ul className="absolute right-[-10px] top-[-290px] block list-none rounded-md bg-white/70 shadow-[0_0_8px_rgba(0,0,0,0.2)] backdrop-blur-sm dark:bg-yellow-800/70">
                    {items &&
                      items.map(
                          ...
                          href && (
                            ...
                            >
                              <a
                                ...
                                className="flex items-center justify-center rounded-sm bg-transparent p-0.5 text-slate-400 hover:bg-cyan-600 hover:text-slate-200 hover:dark:bg-slate-800 hover:dark:text-slate-200"
                              >
