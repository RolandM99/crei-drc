          ...
          >
            <div>
              <div className="mb-6 flex justify-center">
                {Icon && <Icon className="h-14 w-14 text-cyan-600 dark:text-slate-200" />}
              </div>
            ...
            {link && (
              <div className="pt-4">
                <a className="flex font-bold text-cyan-500 underline-offset-auto dark:text-gray-200" href={link.href}>
                  {link.label}
                </a>
              </div>
            )}
