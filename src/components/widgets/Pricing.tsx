              ...
              <div className="card relative flex w-full max-w-sm flex-col justify-between text-center">
                ...
                <ul className="px-2 py-0">
                  ...
                  <li className="mt-5 mb-2.5 flex items-center justify-center text-center font-semibold">
                    <span className="text-5xl dark:text-yellow-800/70">$</span>
                    <span className="text-6xl dark:text-yellow-800/70">{value}</span>
                  </li>
                  ...
                  {texts &&
                    texts.map((item, index) => (
                      ...
                      >
                        <div className="mt-1.5 mr-1.5 flex h-4 w-4 items-center justify-center rounded-full border-2 border-cyan-600 bg-cyan-600">
                ...
                {callToAction && (
                  <CTA data={callToAction as CallToAction} class={`mt-8 ${hasRibbon ? 'bg-cyan-600 hover:text-gray-700 text-cyan-50 border-cyan-600' : ''}`} />
                )}
              </div>
            </div>
          ))}
